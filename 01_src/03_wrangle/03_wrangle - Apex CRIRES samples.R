...
data_crires_bc_wrangled_wide <- data_crires_bc_wrangled_wide |>
  mutate(original_organism_code = organism_code,
         ...
         organism_code_verbose = str_replace(organism_code_verbose, pattern = "^Salmonella\\sparatyphi\\sA$", replacement = "Salmonella enterica subspecies enterica serovar Paratyphi"),
